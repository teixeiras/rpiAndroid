...
package jmdns.impl.tasks.state;
...
public class Announcer extends DNSStateTask {
    ...
    /*
     * (non-Javadoc)
     * @see jmdns.impl.tasks.DNSTask#start(java.util.Timer)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see jmdns.impl.tasks.state.DNSStateTask#getTaskDescription()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see jmdns.impl.tasks.state.DNSStateTask#checkRunCondition()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see jmdns.impl.tasks.state.DNSStateTask#createOugoing()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see jmdns.impl.tasks.state.DNSStateTask#buildOutgoingForDNS(jmdns.impl.DNSOutgoing)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see jmdns.impl.tasks.state.DNSStateTask#buildOutgoingForInfo(jmdns.impl.ServiceInfoImpl, jmdns.impl.DNSOutgoing)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see jmdns.impl.tasks.state.DNSStateTask#recoverTask(java.lang.Throwable)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see jmdns.impl.tasks.state.DNSStateTask#advanceTask()
     */
    @Override
