...
import jmdns.impl.DNSOutgoing.MessageOutputStream;
...
public abstract class DNSRecord extends DNSEntry {
    ...
    /*
     * (non-Javadoc)
     * @see jmdns.impl.DNSEntry#equals(java.lang.Object)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see jmdns.impl.DNSEntry#isExpired(long)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see jmdns.impl.DNSEntry#isStale(long)
     */
    @Override
    ...
    public static class IPv4Address extends Address {
        ...
        /*
         * (non-Javadoc)
         * @see jmdns.impl.DNSRecord#getServiceInfo(boolean)
         */
        @Override
    ...
    public static abstract class Address extends DNSRecord {
        ...
        /*
         * (non-Javadoc)
         * @see jmdns.impl.DNSRecord#getServiceEvent(jmdns.impl.JmDNSImpl)
         */
        @Override
    ...
    public static class Pointer extends DNSRecord {
        ...
        /*
         * (non-Javadoc)
         * @see jmdns.impl.DNSEntry#isSameEntry(jmdns.impl.DNSEntry)
         */
        @Override
    ...
    public static class HostInformation extends DNSRecord {
        ...
        /*
         * (non-Javadoc)
         * @see jmdns.impl.DNSRecord#addAnswer(jmdns.impl.JmDNSImpl, jmdns.impl.DNSIncoming, java.net.InetAddress, int, jmdns.impl.DNSOutgoing)
         */
        @Override
        DNSOutgoing addAnswer(JmDNSImpl dns, DNSIncoming in, InetAddress addr, int port, DNSOutgoing out) throws IOException {
            return out;
        ...
        /*
         * (non-Javadoc)
         * @see jmdns.impl.DNSRecord#handleQuery(jmdns.impl.JmDNSImpl, long)
         */
        @Override
        boolean handleQuery(JmDNSImpl dns, long expirationTime) {
            return false;
        ...
        /*
         * (non-Javadoc)
         * @see jmdns.impl.DNSRecord#handleResponse(jmdns.impl.JmDNSImpl)
         */
        @Override
        boolean handleResponse(JmDNSImpl dns) {
            return false;
        ...
        /*
         * (non-Javadoc)
         * @see jmdns.impl.DNSRecord#sameValue(jmdns.impl.DNSRecord)
         */
        @Override
        boolean sameValue(DNSRecord other) {
        ...
        /*
         * (non-Javadoc)
         * @see jmdns.impl.DNSRecord#isSingleValued()
         */
        @Override
        public boolean isSingleValued() {
            return true;
        ...
        /*
         * (non-Javadoc)
         * @see jmdns.impl.DNSRecord#write(jmdns.impl.DNSOutgoing)
         */
        @Override
        void write(MessageOutputStream out) {
