...
import jmdns.impl.tasks.RecordReaper;
import jmdns.impl.tasks.Responder;
import jmdns.impl.tasks.resolver.ServiceInfoResolver;
import jmdns.impl.tasks.resolver.ServiceResolver;
import jmdns.impl.tasks.resolver.TypeResolver;
import jmdns.impl.tasks.state.Announcer;
import jmdns.impl.tasks.state.Canceler;
import jmdns.impl.tasks.state.Prober;
import jmdns.impl.tasks.state.Renewer;
...
public interface DNSTaskStarter {
    ...
    public static final class DNSTaskStarterImpl implements DNSTaskStarter {
        ...
        /*
         * (non-Javadoc)
         * @see jmdns.impl.DNSTaskStarter#purgeTimer()
         */
        @Override
        ...
        /*
         * (non-Javadoc)
         * @see jmdns.impl.DNSTaskStarter#purgeStateTimer()
         */
        @Override
        ...
        /*
         * (non-Javadoc)
         * @see jmdns.impl.DNSTaskStarter#cancelTimer()
         */
        @Override
        ...
        /*
         * (non-Javadoc)
         * @see jmdns.impl.DNSTaskStarter#cancelStateTimer()
         */
        @Override
        ...
        /*
         * (non-Javadoc)
         * @see jmdns.impl.DNSTaskStarter#startProber()
         */
        @Override
        ...
        /*
         * (non-Javadoc)
         * @see jmdns.impl.DNSTaskStarter#startAnnouncer()
         */
        @Override
        ...
        /*
         * (non-Javadoc)
         * @see jmdns.impl.DNSTaskStarter#startRenewer()
         */
        @Override
        ...
        /*
         * (non-Javadoc)
         * @see jmdns.impl.DNSTaskStarter#startCanceler()
         */
        @Override
        ...
        /*
         * (non-Javadoc)
         * @see jmdns.impl.DNSTaskStarter#startReaper()
         */
        @Override
        ...
        /*
         * (non-Javadoc)
         * @see jmdns.impl.DNSTaskStarter#startServiceInfoResolver(jmdns.impl.ServiceInfoImpl)
         */
        @Override
        ...
        /*
         * (non-Javadoc)
         * @see jmdns.impl.DNSTaskStarter#startTypeResolver()
         */
        @Override
        ...
        /*
         * (non-Javadoc)
         * @see jmdns.impl.DNSTaskStarter#startServiceResolver(java.lang.String)
         */
        @Override
        ...
        /*
         * (non-Javadoc)
         * @see jmdns.impl.DNSTaskStarter#startResponder(jmdns.impl.DNSIncoming, int)
         */
        @Override
