...
public class NetworkTopologyDiscoveryImpl implements NetworkTopologyDiscovery {
    ...
    /*
     * (non-Javadoc)
     * @see jmdns.JmmDNS.NetworkTopologyDiscovery#getInetAddresses()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see jmdns.JmmDNS.NetworkTopologyDiscovery#useInetAddress(java.net.NetworkInterface, java.net.InetAddress)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see jmdns.NetworkTopologyDiscovery#lockInetAddress(java.net.InetAddress)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see jmdns.NetworkTopologyDiscovery#unlockInetAddress(java.net.InetAddress)
     */
    @Override
