...
public interface NameRegister {
    ...
    public static class UniqueNamePerInterface extends BaseRegister {
        ...
        /*
         * (non-Javadoc)
         * @see jmdns.impl.NameRegister#register(java.net.InetAddress, java.lang.String, jmdns.impl.NameRegister.NameType)
         */
        @Override
        ...
        /*
         * (non-Javadoc)
         * @see jmdns.impl.NameRegister#checkName(java.net.InetAddress, java.lang.String, jmdns.impl.NameRegister.NameType)
         */
        @Override
        ...
        /*
         * (non-Javadoc)
         * @see jmdns.impl.NameRegister#incrementHostName(java.net.InetAddress, java.lang.String, jmdns.impl.NameRegister.NameType)
         */
        @Override
