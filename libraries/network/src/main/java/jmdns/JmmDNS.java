...
public interface JmmDNS extends Closeable {
     ...
     * @see jmdns.JmDNS#getInetAddress()
     */
     ...
     * @see jmdns.JmDNS#getServiceInfo(java.lang.String, java.lang.String)
     */
     ...
     * @return list of service info. If no service info is found the list is empty.
     * @see jmdns.JmDNS#getServiceInfo(java.lang.String, java.lang.String, long)
     */
     ...
     * @return list of service info. If no service info is found the list is empty.
     * @see jmdns.JmDNS#getServiceInfo(java.lang.String, java.lang.String, boolean)
     */
     ...
     *            if <code>true</code> ServiceListener.resolveService will be called whenever new new information is received.
     * @return list of service info. If no service info is found the list is empty.
     * @see jmdns.JmDNS#getServiceInfo(java.lang.String, java.lang.String, boolean, long)
     */
     ...
     * @param name
     *            unqualified service name, such as <code>foobar</code> .
     * @see jmdns.JmDNS#requestServiceInfo(java.lang.String, java.lang.String)
     */
     ...
     * @param persistent
     *            if <code>true</code> ServiceListener.resolveService will be called whenever new new information is received.
     * @see jmdns.JmDNS#requestServiceInfo(java.lang.String, java.lang.String, boolean)
     */
     ...
     * @see jmdns.JmDNS#requestServiceInfo(java.lang.String, java.lang.String, long)
     */
     ...
     * @param timeout
     *            timeout in milliseconds
     * @see jmdns.JmDNS#requestServiceInfo(java.lang.String, java.lang.String, boolean, long)
     */
     ...
     * @exception IOException
     * @see jmdns.JmDNS#addServiceTypeListener(jmdns.ServiceTypeListener)
     */
     ...
     * @param listener
     *            listener for service types
     * @see jmdns.JmDNS#removeServiceTypeListener(jmdns.ServiceTypeListener)
     */
     ...
     * @see jmdns.JmDNS#addServiceListener(java.lang.String, jmdns.ServiceListener)
     */
     ...
     * @param listener
     *            listener for service updates
     * @see jmdns.JmDNS#removeServiceListener(java.lang.String, jmdns.ServiceListener)
     */
     ...
     * @exception IOException
     * @see jmdns.JmDNS#registerService(jmdns.ServiceInfo)
     */
     ...
     * @see jmdns.JmDNS#unregisterService(jmdns.ServiceInfo)
     */
     ...
     *
     * @see jmdns.JmDNS#unregisterAllServices()
     */
     ...
     * @param type
     *            full qualified service type, such as <code>_http._tcp.local.</code>.
     * @see jmdns.JmDNS#registerServiceType(java.lang.String)
     */
     ...
     * @see jmdns.JmDNS#list(java.lang.String)
     */
     ...
     * @return An array of service instance.
     * @see jmdns.JmDNS#list(java.lang.String, long)
     */
     ...
     * @see jmdns.JmDNS#listBySubtype(java.lang.String)
     */
     ...
     *            timeout in milliseconds. Typical timeout should be 6s.
     * @return A dictionary of service info by subtypes.
     * @see jmdns.JmDNS#listBySubtype(java.lang.String, long)
     */
